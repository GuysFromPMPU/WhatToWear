      ...
      var clothesList = new List<Clothes>
            {
                ...
                new Clothes {Type = "headwear", Name = "Women hat", Gender = "female", MinTemp = 5, MaxTemp = 30 },
                ...
                new Clothes {Type = "sweater", Name = "Sweater", Gender = "unisex", MinTemp = -2, MaxTemp = 20},
                new Clothes {Type = "sweater", Name = "Sweater with hood", Gender = "male", MinTemp = -100, MaxTemp = 10},
                new Clothes {Type = "sweater", Name = "Shirt with vest", Gender = "male", MinTemp = -100, MaxTemp = 15},

                new Clothes {Type = "jacket", Name = "Warm anorak", Gender = "unisex", MinTemp = -100, MaxTemp = 10},
                new Clothes {Type = "jacket", Name = "Jacket", Gender = "unisex", MinTemp = -15, MaxTemp = 15},
                new Clothes {Type = "jacket", Name = "Men coat", Gender = "male", MinTemp = -5, MaxTemp = 10},
                new Clothes {Type = "jacket", Name = "Men jacket", Gender = "male", MinTemp = 10, MaxTemp = 20},
                new Clothes {Type = "jacket", Name = "Sport jacket", Gender = "male", MinTemp = 20, MaxTemp = 100},
                new Clothes {Type = "jacket", Name = "Parka", Gender = "unisex", MinTemp = -100, MaxTemp = 10},
                ...
                new Clothes {Type = "footwear", Name = "Warm boots", Gender = "unisex", MinTemp = -100, MaxTemp = 5},

                new Clothes {Type = "other", Name = "Gloves", Gender = "unisex", MinTemp = -100, MaxTemp = 7},
                new Clothes {Type = "other", Name = "Umbrella", Gender = "unisex", MinTemp = -100, MaxTemp = 40}
            };
